...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'Adds oportunity to make bundle of products to your Spree store'
  spec.description = 'Adds oportunity to make bundle of products to your Spree store'
  ...
  spec.metadata['changelog_uri'] = 'https://github.com/solidusio-contrib/solidus_product_assembly/blob/master/CHANGELOG.md'
